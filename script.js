...
const cocktails = [
    { name: "АПЕРОЛЬ ШПРИНЦ", image: "images/1.jpg" },
    { name: "МАРТИНИ ПОРНСТАР", image: "images/2.jpg" },
    { name: "МАРТИНИ РОЯЛЕ", image: "images/3.jpg" },
    { name: "МАТИЛЬДА", image: "images/4.jpg" },
    { name: "КИР РОЯЛЬ", image: "images/5.jpg" },
    { name: "БРАМБЛ", image: "images/6.jpg" },
    { name: "КЛОВЕР КЛАБ", image: "images/7.jpg" },
    { name: "НЕГРОНИ", image: "images/8.jpg" },
    { name: "МАЛИНОВЫЙ НЕГРОНИ", image: "images/9.jpg" },
    { name: "ЯБЛОЧНЫЙ ТИНИ", image: "images/10.jpg" },
    { name: "ГРЮТ МУЛ", image: "images/11.jpg" },
    { name: "ЛИМОННЫЙ ПИРОГ", image: "images/12.jpg" },
    { name: "МАРГАРИТА", image: "images/13.jpg" },
    { name: "САНДЕНС", image: "images/14.jpg" },
    { name: "ВИСКИ САУЭР", image: "images/15.jpg" },
    { name: "ОЛД ФЭШН", image: "images/16.jpg" },
    { name: "БУЛЬВАРДЬЕ", image: "images/17.jpg" },
    { name: "ДАЙКИРИ", image: "images/18.jpg" },
    { name: "КО-ПАНГАН", image: "images/19.jpg" },
    { name: "МАЙ ТАЙ", image: "images/20.jpg" },
    { name: "МОХИТО", image: "images/21.jpg" },
    { name: "ЛОНГ АЙЛЕНД", image: "images/22.jpg" }
];
...
function handleKeyboard(e) {
    ...
    else if (e.key === 'ArrowRight') nextCocktail();
}
...
function init() {
    ...
    function handleSwipe() {
        ...
        if (touchEndX < touchStartX - swipeThreshold) nextCocktail();
        else if (touchEndX > touchStartX + swipeThreshold) prevCocktail();
    }
}
